...
def __setup_bzlmodrio_phoenix_java_dependencies(mctx):
    jvm_maven_import_external(
        ...
        artifact = "com.ctre.phoenix:api-java:5.34.0-beta-4",
        artifact_sha256 = "127f5a1abcbee32072aba63e780f94909523fe2a84462de7dbeb8dfadbf2d803",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
    jvm_maven_import_external(
        name = "com_ctre_phoenix_wpiapi_java",
        artifact = "com.ctre.phoenix:wpiapi-java:5.34.0-beta-4",
        artifact_sha256 = "8b47635517d66c4be5eab0956453c9cf10f43b7e1c91a7c43c31a4b35a01e7fc",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
