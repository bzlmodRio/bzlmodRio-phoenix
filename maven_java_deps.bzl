...
def __setup_bzlmodrio_phoenix_java_dependencies(mctx):
    jvm_maven_import_external(
        ...
        artifact = "com.ctre.phoenix:api-java:5.34.0-beta-2",
        artifact_sha256 = "294e35d9c134bb0cce4b11de3ea6a7cc921fb2e3e015646b0c8984507ff79367",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
    jvm_maven_import_external(
        name = "com_ctre_phoenix_wpiapi_java",
        artifact = "com.ctre.phoenix:wpiapi-java:5.34.0-beta-2",
        artifact_sha256 = "cf12e9db121a7453bf7515c376acb65a99ce0068e4bfb762c1f8a256c2d75394",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
