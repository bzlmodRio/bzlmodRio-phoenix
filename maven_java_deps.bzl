...
def __setup_bzlmodrio_phoenix_java_dependencies(mctx):
    jvm_maven_import_external(
        ...
        artifact = "com.ctre.phoenix:api-java:5.36.0-beta-1",
        artifact_sha256 = "2e5e6692144a9b046e79d483c5a132269333cbea83d4a10733c09f0015e41e0b",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
    jvm_maven_import_external(
        name = "com_ctre_phoenix_wpiapi_java",
        artifact = "com.ctre.phoenix:wpiapi-java:5.36.0-beta-1",
        artifact_sha256 = "f6fc44ed1a4c5e245c45c0a1f6236e737be261cefc052cbf3913f57f74d35b1c",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
