...
def __setup_bzlmodrio_phoenix_java_dependencies(mctx):
    jvm_maven_import_external(
        ...
        artifact = "com.ctre.phoenix:api-java:5.35.0",
        artifact_sha256 = "c3f221183c07eea74516352f8d4ca383fc2a6605b97bac7500b6c868fc749a1e",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
    jvm_maven_import_external(
        name = "com_ctre_phoenix_wpiapi_java",
        artifact = "com.ctre.phoenix:wpiapi-java:5.35.0",
        artifact_sha256 = "67cd69fd54dbb1e5c1d607bbf0070c55fb835b87a8fcc3c49ddda4d093ff454d",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
