...
def __setup_bzlmodrio_phoenix_java_dependencies(mctx):
    jvm_maven_import_external(
        ...
        artifact = "com.ctre.phoenix:api-java:5.36.0",
        artifact_sha256 = "16747b57eebb9a6ed5da8e5934efa534407b5476df98bcf70a66342a76999bea",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
    jvm_maven_import_external(
        name = "com_ctre_phoenix_wpiapi_java",
        artifact = "com.ctre.phoenix:wpiapi-java:5.36.0",
        artifact_sha256 = "9c823ead65aebb031db683cd0a58db199e0cf4f2da54ce2c27375bd5563621e9",
        server_urls = ["https://maven.ctr-electronics.com/release"],
    )
